...
const translations: Translations = {
  en: {
    ...
    "hero.subtitle": "High-Intent, Pre-Qualified Live Call Transfers across Medicare, ACA, Final Expense, Auto, and Life Insurance. Scale your business from 100 monthly to 500+ daily transfers with ready to enroll prospects who call YOU.",
